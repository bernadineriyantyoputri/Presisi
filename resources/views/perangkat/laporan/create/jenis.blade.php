...
@section('content')
    ...
    <div class="laporan-wizard-page">
        ...
        <div class="d-flex justify-content-between align-items-start mb-4 flex-wrap gap-3">
            ...
            <div class="step-wizard-top">
                <div class="step-top-item active">
                    <div class="step-top-circle">1</div>
                    <span class="step-top-label">Jenis</span>
                </div>
                <div class="step-top-line"></div>
                <div class="step-top-item">
                    <div class="step-top-circle">2</div>
                    <span class="step-top-label">Objek</span>
                </div>
                <div class="step-top-line"></div>
                <div class="step-top-item">
                ...
                <div class="step-top-line"></div>
                <div class="step-top-item">
                    <div class="step-top-circle">4</div>
                    <span class="step-top-label">Detail</span>
                </div>
                <div class="step-top-line"></div>
                <div class="step-top-item">
                    <div class="step-top-circle">5</div>
            ...
            <div class="col-md-8">
                <form method="POST" action="{{ route('perangkat.laporan.create.jenis') }}">
                    ...
                    <div class="d-flex justify-content-between align-items-center py-3 border-top">
                        <a href="{{ route('perangkat.laporan.index') }}" class="btn btn-outline-secondary rounded-pill px-4">Batal</a>
