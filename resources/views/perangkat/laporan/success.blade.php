...
@section('content')
    ...
    <div class="laporan-wizard-page">
        ...
        <div class="card shadow-sm border-0 mb-3">
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h5 class="judul-pratinjau fw-bold mb-0">Pratinjau Laporan (PDF)</h5>
                ...
                <div class="ratio" style="--bs-aspect-ratio: 130%;">
                    <iframe src="{{ route('perangkat.laporan.pdf', $laporan->id) }}"
                        style="border: 1px solid #e9ecef; border-radius: 8px;" title="Preview Laporan Retribusi">
                    </iframe>
                </div>
            </div>
        </div>
        ...
        <div class="d-flex justify-content-end mt-4">
            <a href="{{ route('perangkat.laporan.index') }}" class="btn btn-lanjut">
