                        ...
                        @forelse($data as $i => $rincian)
                            <tr>
                                            ...
                                            @foreach($rincian->detail as $detail)
                                                <div class="detail-action-item">
                                                    ...
                                                    <button type="button" class="jr-icon-btn jr-icon-btn-edit" data-bs-toggle="modal"
                                                        data-bs-target="#modalEditDetail{{ $detail->id }}" title="Edit Detail">
                                                        <i class="bi bi-pencil"></i>
                                                    </button>

                                                    {{-- HAPUS DETAIL --}}
                                                    <button type="button" class="jr-icon-btn jr-icon-btn-delete" data-bs-toggle="modal"
                                                        data-bs-target="#modalDeleteDetail{{ $detail->id }}" title="Hapus Detail">
                                ...
                                <td class="text-end">
                                    ...
                                    {{-- TAMBAH DETAIL --}}
                                    <button type="button" class="jr-icon-btn jr-icon-btn-add" data-bs-toggle="modal"
                                        data-bs-target="#modalTambahDetail{{ $rincian->id }}" title="Tambah Detail">
                                        <i class="bi bi-plus-lg"></i>
                                    </button>

                                    {{-- EDIT RINCIAN --}}
                                    <button type="button" class="jr-icon-btn jr-icon-btn-edit" data-bs-toggle="modal"
                                        data-bs-target="#modalEditRincian{{ $rincian->id }}" title="Edit Rincian">
                                        <i class="bi bi-pencil"></i>
                                    </button>

                                    {{-- HAPUS RINCIAN --}}
                                    <button type="button" class="jr-icon-btn jr-icon-btn-delete" data-bs-toggle="modal"
                                        data-bs-target="#modalDeleteRincian{{ $rincian->id }}" title="Hapus Rincian">
                                        <i class="bi bi-trash"></i>
                                    </button>
                            ...
                            @foreach($rincian->detail as $detail)
                                        ...
                                        <form action="{{ route('admin.detail.update', $detail->id) }}" method="POST">
                                            ...
                                            <div class="modal-content jr-modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="text" class="form-control" value="{{ $rincian->nama_rincian }}"
                                                        readonly>
                                                    ...
                                                    <input type="text" name="nama_detail" class="form-control"
                                                        value="{{ $detail->nama_detail }}" required>
                                ...
                                MODAL HAPUS DETAIL
                                ====================================================== --}}
                                <div class="modal fade" id="modalDeleteDetail{{ $detail->id }}" tabindex="-1">
                            ...
                            MODAL TAMBAH DETAIL
                            ========================================================== --}}
                            <div class="modal fade" id="modalTambahDetail{{ $rincian->id }}" tabindex="-1">
                                    ...
                                    <form action="{{ route('admin.detail.store') }}" method="POST">
                                        ...
                                        <div class="modal-content jr-modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <input type="text" name="nama_detail" class="form-control"
                                                    placeholder="Masukkan nama detail" required>
                ...
                <div class="modal-content jr-modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="text" name="nama_objek" class="form-control @error('nama_objek') is-invalid @enderror"
                            value="{{ old('nama_objek') }}" placeholder="Masukkan nama objek retribusi" required>
                        <label class="form-label mt-3">
                            Nama Rincian
                            <span class="text-danger">*</span>
                        </label>

                        <input type="text" name="nama_rincian"
